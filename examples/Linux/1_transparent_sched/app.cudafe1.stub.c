...
#include "app.fatbin.c"
extern void __device_stub__Z10vector_addPKfS0_Pfi(const float *, const float *, float *, int);
...
# 1 "app.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T3) {  __nv_dummy_param_ref(__T3); __nv_save_fatbinhandle_for_managed_rt(__T3); __cudaRegisterEntry(__T3, ((void ( *)(const float *, const float *, float *, int))vector_add), _Z10vector_addPKfS0_Pfi, (-1)); }
